...
class Music(commands.Cog):
    ...
    @commands.command(name="chamelt")
    async def _function_chamelt(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
    ...
    @commands.command(name="3ak3ak")
    async def _function_3ak3ak(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
    ...
    @commands.command(name="_eve")
    async def _function_eve(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
    ...
    @commands.command(name="_nejla")
    async def _function_nejla(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
    ...
    @commands.command(name="_divix")
    async def _function_divix(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
    ...
    @commands.command(name="firas_wassup")
    async def _function_firas(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
    ...
    @commands.command(name="despa")
    async def _function_despa(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
    ...
    @commands.command(name="mpaka")
    async def _function_mpaka(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
    ...
    @commands.command(name="makky")
    async def _function_nicenice(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
    ...
    @commands.command(name="salam")
    async def _function_salam(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
    ...
    @commands.command(name="mizwed")
    async def _function_mizyed(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
    ...
    async def _function_rawr(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
